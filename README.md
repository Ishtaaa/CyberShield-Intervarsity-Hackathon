# CyberShield Academy - SA Intervarsity Hackathon 2025

**CyberShield Academy** is a web-based educational platform that simulates real-world cyber threats in a safe, engaging environment. Users interact with virtual desktop applications including email, phone, browser, and security tools while progressing through cybersecurity challenges and earning XP.

🌐 **Live Demo**: https://cybershield-academy.netlify.app/

## ✨ Key Features

- **Virtual Desktop Environment**: Drag-and-drop applications in a simulated OS interface
- **Interactive Learning**: Email phishing detection, password strength testing, and security quizzes
- **Gamified Progression**: Earn XP and level up while learning cybersecurity best practices
- **Story-driven Missions**: Progress through cyber defense scenarios with mission updates
- **Real-time Feedback**: Instant responses to security decisions and learning activities
...
- **Animations**: GSAP, Anime.js, Lottie
- **Build**: Vite
- **Deployment**: Netlify
...
├── src/
│   ├── lib/
│   │   ├── components/    # UI components, stores, helper logic
│   │   └── index.ts
│   ├── routes/            # SvelteKit pages (desktop, quiz, horror, etc)
│   └── app.css            # Tailwind/DaisyUI CSS
│   
├── vendor/
│   └── README.md
├── .dockerignore
